    ...
    <main className="ov-courses-page">
      ...
      <section className="ov-courses-hero">
        <div className="ov-courses-hero-content">
          ...
          <p>
            Six practical learning paths. Clear course fees, hands-on projects,
            and a next step you can take with confidence.
          </p>
      ...
      <section className="ov-courses-intro" id="all-courses">
        <div className="ov-courses-section-head">
          <span>All six courses</span>
          <h2>Choose what you want to build next.</h2>
          <p>
            Scholarship fees and class formats depend on your chosen course.
          </p>
        </div>
